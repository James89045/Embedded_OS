...
#define GPIO_7  (7)
#define GPIO_8  (8)// 8
#define GPIO_25 (25)// 25
#define GPIO_24 (24)// 24
dev_t dev = 0;
...
static int __init etx_driver_init(void)
{
    ...
    if(gpio_is_valid(GPIO_21) == false || gpio_is_valid(GPIO_16) == false || gpio_is_valid(GPIO_12) == false || gpio_is_valid(GPIO_7) == false || gpio_is_valid(GPIO_8) == false || gpio_is_valid(GPIO_25) == false || gpio_is_valid(GPIO_24) == false) {
        pr_err("GPIO %d is not valid\n", GPIO_21);
        goto r_device;
    }
    //Requesting the GPIO
    if(gpio_request(GPIO_21,"GPIO_21") < 0 || gpio_request(GPIO_12,"GPIO_12") < 0 || gpio_request(GPIO_16,"GPIO_16") < 0 || gpio_request(GPIO_7,"GPIO_7") || gpio_request(GPIO_8,"GPIO_8") < 0 || gpio_request(GPIO_25,"GPIO_25") < 0 || gpio_request(GPIO_24,"GPIO_24") < 0) {
